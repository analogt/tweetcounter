...
var request = client.request("GET", '/1/statuses/filter.json?track=some_keyword',{
	"Host":"stream.twitter.com",
	"Authorization":"Basic " + new Buffer('atriv' + ":" + 'c1n0sweiV11%twit').toString('base64'), //Need to create buffer object and base64 encode it
